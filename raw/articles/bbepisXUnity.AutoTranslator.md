---
title: "bbepis/XUnity.AutoTranslator"
source: "https://github.com/bbepis/XUnity.AutoTranslator"
author:
published:
created: 2026-04-06
description: "Contribute to bbepis/XUnity.AutoTranslator development by creating an account on GitHub."
tags:
  - "clippings"
---
...
2. Download XUnity.AutoTranslator-ReiPatcher-{VERSION}.zip from [releases](https://github.com/bbepis/XUnity.AutoTranslator/releases).
...
1. Download XUnity.AutoTranslator-BepInEx-{VERSION}.zip from [releases](https://github.com/bbepis/XUnity.AutoTranslator/releases).
...
1. Download XUnity.AutoTranslator-MelonMod-{VERSION}.zip from [releases](https://github.com/bbepis/XUnity.AutoTranslator/releases).
...
1. Download XUnity.AutoTranslator-UnityInjector-{VERSION}.zip from [releases](https://github.com/bbepis/XUnity.AutoTranslator/releases).
...
- CustomTranslate. You can also specify any custom HTTP url that can be used as a translation endpoint (GET request). This must use the query parameters "from", "to" and "text" and return only a string with the result (try HTTP without SSL first, as unity-mono often has issues with SSL).
	- *NOTE: This is a developer-centric option. You cannot simply specify "CustomTranslate" and expect it to work with any arbitrary translation service you find online. See [FAQ](#frequently-asked-questions)*
		...
		- Endpoint=CustomTranslate
				- \[Custom\]
				- Url= [http://my-custom-translation-service.net/translate](http://my-custom-translation-service.net/translate)
		- Example Request: GET [http://my-custom-translation-service.net/translate?from=ja&to=en&text=こんにちは](http://my-custom-translation-service.net/translate?from=ja&to=en&text=%E3%81%93%E3%82%93%E3%81%AB%E3%81%A1%E3%81%AF)
		- Example Response (only body): Hello
		- Known implementations that can be used with CustomTranslate:
		- ezTrans: [https://github.com/HelloKS/ezTransWeb](https://github.com/HelloKS/ezTransWeb)
...
Since 3.0.0, you can also implement your own translators. To do so, follow the instruction [here](#implementing-a-translator). Here are some third-party translation plugins that you can use with AutoTranslator:
...
1. Download XUnity.AutoTranslator-Developer-{VERSION}.zip from [releases](https://github.com/bbepis/XUnity.AutoTranslator/releases)
