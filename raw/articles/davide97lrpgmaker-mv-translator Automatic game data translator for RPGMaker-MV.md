---
title: "davide97l/rpgmaker-mv-translator: Automatic game data translator for RPGMaker-MV"
source: "https://github.com/davide97l/rpgmaker-mv-translator"
author:
published:
created: 2026-04-06
description: "Automatic game data translator for RPGMaker-MV. Contribute to davide97l/rpgmaker-mv-translator development by creating an account on GitHub."
tags:
  - "clippings"
---
...
| --- | --- |
| [![](https://github.com/davide97l/rpgmaker-mv-translator/raw/main/images/ita2.jpg)](https://github.com/davide97l/rpgmaker-mv-translator/blob/main/images/ita2.jpg) | [![](https://github.com/davide97l/rpgmaker-mv-translator/raw/main/images/en2.jpg)](https://github.com/davide97l/rpgmaker-mv-translator/blob/main/images/en2.jpg) |
| [![](https://github.com/davide97l/rpgmaker-mv-translator/raw/main/images/ita1.jpg)](https://github.com/davide97l/rpgmaker-mv-translator/blob/main/images/ita1.jpg) | [![](https://github.com/davide97l/rpgmaker-mv-translator/raw/main/images/en1.jpg)](https://github.com/davide97l/rpgmaker-mv-translator/blob/main/images/en1.jpg) |
...
1. Most important arguments explanation:
	- `source_lang`: (string) the **original language** of your game (en - english, it - italian, zh - chinese, fr -french, sp - spanish, de - deutsch,...).
		...
		- `print_neatly`: (bool) if True, adapts the translated sentence to fit the dialog window. This is because, by default, each dialog window row is a unique string itself and its length can change after translation. This option also improves the translation quality because each dialog window would be translated at once without translating each row one by one which causes loss of context. If you are curious how this algorithm works you can check this [blog](https://davideliu.com/2019/12/22/print-neatly/).
